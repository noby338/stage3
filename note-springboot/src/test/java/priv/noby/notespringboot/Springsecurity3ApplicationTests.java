...
class SpringSecurity3ApplicationTests {
    ...
    @Test
    void contextLoads2() {
        System.out.println("new ResponseEntity(null, null, HttpStatus.UNAUTHORIZED) = " + new ResponseEntity(null, null, HttpStatus.UNAUTHORIZED));
        System.out.println("ResponseEntity.ok() = " + ResponseEntity.ok());
    }
